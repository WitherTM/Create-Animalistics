...
@Mod("animalistics")
public class AnimalisticsMod {
	public static final Logger LOGGER = LogManager.getLogger(AnimalisticsMod.class);
	public static final String MODID = "animalistics";
	...
	public AnimalisticsMod() {
		...
		AnimalisticsModItems.REGISTRY.register(bus);
